...
// ============================================================================
//
// This file ties the physics modules together:
...
function createBodies() {
    return [
        createRect(1.2, 3.5, 0.7, 0.7),
        createRect(2.5, 3.5, 0.9, 0.55),
        createRect(3.8, 3.5, 0.5, 0.85),
        createRect(5.0, 3.5, 0.65, 0.65),
        createRect(6.2, 3.5, 1.0, 0.45),
        createRect(7.5, 3.5, 0.6, 0.8),
        createRect(8.7, 3.5, 0.55, 0.55),
        createRect(4.5, 5.5, 0.8, 0.5),
    ];
}
